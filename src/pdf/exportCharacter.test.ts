...
import { addPortraitToPdf, createPdfTranslator, detectImageFormat } from './exportCharacter';
...
describe('formato do retrato', () => {
  ...
  it('usa o idioma selecionado nos labels do PDF', () => {
    expect(createPdfTranslator('pt-BR')('sheet.saves')).toBe('Salvaguardas');
    expect(createPdfTranslator('en-US')('sheet.saves')).toBe('Saving Throws');
  });
