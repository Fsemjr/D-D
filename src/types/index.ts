...
export type PresetRoleKey = 'role.tank' | 'role.barbarian' | 'role.rogue' | 'role.wizard' | 'role.cleric' | 'role.paladin' | 'role.ranger' | 'role.bard' | 'role.monk' | 'role.warlock';

export interface CharacterPreset {
  id: string;
  title: string;
  roleKey: PresetRoleKey;
